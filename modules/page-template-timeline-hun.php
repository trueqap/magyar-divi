					...
					<div class="timeline-container">
						<div id="timeline-sticky-header" class="et_extra_other_module timeline-module">
							<div class="module-head">
								...
								<h1 class="module-title-months"></h1>
						...
						<div id="timeline" class="timeline mobile">
							...
							<?php require (plugin_dir_path(__FILE__) . 'timeline-posts-content-hun.php' ); ?>
							<div class="loader">
						...
						<div class="timeline-nav">
							<ul id="timeline-menu" class="timeline-menu">
								...
								foreach ( $month_groups as $month_group ) {
									...
									$month = str_replace($extra_angol_honapok, $extra_magyar_honapok, $month);

									printf( '<li class="month year-%1$d"><a href="#%2$s_%1$d" data-month="%2$s" data-year="%1$d">%3$s</a></li>', 
										esc_attr( $year ), esc_attr( strtolower( $month ) ), esc_html( $month ) );
